...
export const series: GallerySeries[] = [
  {
    id: "crowned-figure",
    intro:
      "An ornamented figure taken from symmetrical construction lines through to a flat colour pass, with the crown, horns, and blade motif blocked in over the structure before any rendering.",
  },
  {
    id: "winged-creature",
    intro:
      "A creature design built in two passes: the anatomy first, then armour laid directly over it so every plate follows the muscle group underneath.",
  },
];
...
export const gallery: GalleryPiece[] = [
  ...
  // real finish dates whenever; the gallery sorts newest-first by this field.
  {
    ...
    description:
      "Flat colour pass over the construction lines: crown, horns, and blade motif blocked in.",
    date: "2026-08",
  ...
  },
  {
    ...
    description:
      "Weight on all fours in low light. Scapula, spine, and loaded shoulders carry the pose.",
    date: "2026-06",
  ...
  },
  {
    ...
    description:
      "Silhouette-first pose study of a kneeling figure reaching into the dark.",
    date: "2026-05",
    tags: ["anatomy"],
    nsfw: false,
  },
