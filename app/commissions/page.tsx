    ...
    <div className="max-w-6xl mx-auto px-5 pt-14">
      ...
      <Reveal>
        <p className="text-muted max-w-2xl leading-relaxed mb-12">
          {open
            ? c.howToOrder
            : "Commissions are currently closed — the tiers and terms below are kept up to date so you can plan for the next opening. Follow my socials for the announcement."}
        </p>
      </Reveal>
      ...
      <Reveal>
        <div className="border border-amber p-8 sm:p-10 text-center mb-4">
          ...
          <p className="text-muted text-sm mb-6">
            {site.email} — include references and the tier you're after.
          </p>
          <a
            href={mailto}
